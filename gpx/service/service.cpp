...
//**********************************************************************************************
bool_t service::register_user_data( so_std::string_cref_t name, so_gpx::iuser_data_ptr_t ud_ptr )
{
...
//**********************************************************************************************
bool_t service::acquire_user_data( so_std::string_cref_t name, so_gpx::iuser_data_ptr_t & ud_ptr_out )
{
    so_thread::lock_guard_t lk( _mtx_ud ) ;
