...
//------------------------------------------------------------
#ifndef _SNAKEOIL_PROPERTY_STRING_PROPERTY_HPP_
#define _SNAKEOIL_PROPERTY_STRING_PROPERTY_HPP_
...
{
    class string_property : public generic_base_property<so_std::utf8_t>
    {
        typedef generic_base_property<so_std::utf8_t> base_t ;
        so_this_typedefs( string_property ) ;
        so_typedefs( so_std::utf8_t, value ) ;

    public:

        string_property( so_std::utf8_t name ) : base_t( name )
        {}

        string_property( this_cref_t rhv ) : base_t( rhv )
        {}

        string_property( this_rref_t rhv ) : base_t( std::move( rhv ) )
        {}

        string_property( so_std::utf8_t name, value_cref_t value ) : base_t( name, value )
        {}

        string_property( so_std::utf8_t name, value_rref_t value ) : base_t( name, std::move( value ) )
        {}

        virtual ~string_property( void_t )
        {}
