...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_VECTOR3_HPP_
#define _SNAKEOIL_MATH_VECTOR3_HPP_
...
namespace so_math
{
    ...
    class vector3
    {
        so_this_typedefs( vector3< T > ) ;

    public:

        so_typedefs( T, type ) ;
        so_typedefs( vector2<T>, vec2 ) ;
        so_typedefs( vector3<T>, vec3 ) ;
        so_typedefs( vector4<T>, vec4 ) ;
        so_typedefs( vector3b, vec3b ) ;
        so_typedefs( quaternion3< T >, quat3 ) ;
    ...
    public: // ctor
        ...
        //************************************************************************************
        vector3( so_vector::x_axis ) :
            vector3(type_t(1),type_t(0), type_t(0))
        {}

        //************************************************************************************
        vector3( so_vector::y_axis ) :
            vector3(type_t(0),type_t(1), type_t(0))
        {}

        //************************************************************************************
        vector3( so_vector::z_axis ) :
    ...
    so_typedefs( vector3<char_t>, vec3c ) ;
