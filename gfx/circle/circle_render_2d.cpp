...
//------------------------------------------------------------
#include "circle_render_2d.h"
#include "circle_render_2d_plug_factory.h"
...
//************************************************************************************
circle_render_2d::circle_render_2d( so_gpx::render_system_ptr_t rsptr )
{
    _gpxr = rsptr ;

    _sd_ptr = so_gfx::memory::alloc( so_gfx::circle_render_2d_shared_data_t(),
        "[circle_render_2d::circle_render_2d]" ) ;

    _fac_ptr = so_gfx::circle_render_2d_plug_factory_t::create(
        so_gfx::circle_render_2d_plug_factory_t( _sd_ptr ), "[circle_render_2d::circle_render_2d_plug_factory]" ) ;
}

//************************************************************************************
circle_render_2d::circle_render_2d( this_rref_t rhv )
{
...
//************************************************************************************
circle_render_2d::~circle_render_2d( void_t )
{
...
//************************************************************************************
void_t circle_render_2d::init( void_t )
{
    if( _t_rnd == so_gpx::technique_id_t( -1 ) )
...
//************************************************************************************
void_t circle_render_2d::set_view_projection( so_math::mat4f_cref_t view, so_math::mat4f_cref_t proj )
{
    _proj = proj ;
    _view = view ;
}
...
//************************************************************************************
circle_render_2d::this_ptr_t circle_render_2d::create( this_rref_t rhv, so_memory::purpose_cref_t p )
{
    return so_gfx::memory::alloc( std::move( rhv ), p ) ;
}

//************************************************************************************
void_t circle_render_2d::destroy( this_ptr_t ptr )
{
    so_gfx::memory::dealloc( ptr ) ;
}

//************************************************************************************
so_gfx::result circle_render_2d::prepare_for_rendering( void_t )
{
    ...
    for( auto * gptr : _group_infos )
    {
        // 1. copy group infos
        {
            so_gfx::circle_render_2d_shared_data_t::per_group_info_t pgi ;
        ...
        // 2. copy line infos
        {
            ...
            {
                so_gfx::circle_render_2d_shared_data_t::rect_info_t ri ;
...
//************************************************************************************
so_gfx::result circle_render_2d::draw_circle( size_t const group_id, so_math::vec2f_cref_t pos, so_math::vec2f_cref_t pivot, 
    ...
    // 1. find and/or insert group
    {
        ...
        if( iter == _group_infos.end() )
        {
            ...
            gi_ptr = so_gfx::memory::alloc( this_t::group_info_t( std::move( gi ) ),
                "[circle_render_2d::draw_lines] : group_infos" ) ;
...
//************************************************************************************
bool_t circle_render_2d::need_to_render( size_t const gid ) const
{
...
//************************************************************************************
so_gfx::result circle_render_2d::render( size_t const gid )
{
    {
...
//************************************************************************************
so_gfx::result circle_render_2d::release( void_t )
{
