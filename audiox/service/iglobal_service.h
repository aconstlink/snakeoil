...
//------------------------------------------------------------
#ifndef _SNAKEOIL_AUDIOX_SERVICE_IGLOBAL_SERVICE_H_
#define _SNAKEOIL_AUDIOX_SERVICE_IGLOBAL_SERVICE_H_
...
namespace so_audiox
{
    class SNAKEOIL_AUDIOX_API iglobal_service
    {
    ...
    public:
        ...
        {
            so_audiox::iuser_data_ptr_t iud_ptr ;
