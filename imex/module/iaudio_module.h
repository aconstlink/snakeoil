...
//------------------------------------------------------------
#ifndef _SNAKEOIL_IMEX_MODULE_IAUDIO_MODULE_H_
#define _SNAKEOIL_IMEX_MODULE_IAUDIO_MODULE_H_
...
namespace so_imex
{
    class SNAKEOIL_IMEX_API iaudio_module
    {
    public:
    ...
    public:
        ...
        virtual so_thread::task_graph_t import_audio( import_params_cref_t ) = 0 ;
        virtual so_thread::task_graph_t export_audio( export_params_cref_t ) = 0 ;

    public:

        virtual so_imex::result destroy( void_t ) = 0 ;
    };
    so_typedef( iaudio_module ) ;
}
