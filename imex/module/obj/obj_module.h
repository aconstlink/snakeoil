...
//------------------------------------------------------------
#ifndef _SNAKEOIL_IMEX_MODULE_OBJ_OBJ_MODULE_H_
#define _SNAKEOIL_IMEX_MODULE_OBJ_OBJ_MODULE_H_

#include "../iscene_module.h"

#include "obj_export_context.h"
...
namespace so_imex
{
    class SNAKEOIL_IMEX_API obj_module : public so_imex::iscene_module
    {
        so_this_typedefs( obj_module ) ;
