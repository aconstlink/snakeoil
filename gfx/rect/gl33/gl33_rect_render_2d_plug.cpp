...
so_gpx::plug_result gl33_rect_render_2d_plug::on_load( load_info_cref_t li )
{
    ...
    auto const base = so_gfx::find_shader_path( "/rect/gl33/shader" ) ;
    ...
    // text render shader
    {
...

        {
            ...
            vsh.wait_for_operation( [&] ( char_cptr_t din, size_t sib, so_io::result res )
            {
                so_log::global::error_and_exit( so_io::no_success( res ),
                    "[gl33_rect_render_2d_plug::on_load] : Vertex shader not found : " + vs_path.string() ) ;
...

        {
            ...
            {
                so_log::global::error_and_exit( so_io::no_success( res ),
                    "[gl33_rect_render_2d_plug::on_load] : Pixel shader not found : " + ps_path.string() ) ;
