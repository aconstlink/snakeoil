...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_PRIMITIVE_2D_LINE_SEGMENT_HPP_
#define _SNAKEOIL_MATH_PRIMITIVE_2D_LINE_SEGMENT_HPP_
...
namespace so_math
{
    ...
    typedef so_2d::line_segment< float > line_segment2f_t ;
}
