...
namespace so_gfx
{
    namespace so_gl33
    {
        class SNAKEOIL_GFX_API gl33_vignette_post_plug :
            public gl33_singlepass_post_plug
        {
            typedef gl33_singlepass_post_plug this_base_t ;
            so_this_typedefs( gl33_vignette_post_plug ) ;
        ...
        public:
            ...
            gl33_vignette_post_plug( predef_post_t::shared_data_ptr_t,
                so_gpu::so_gl::igl_33_api_ptr_t ) ;
            gl33_vignette_post_plug( this_cref_t ) = delete ;
            gl33_vignette_post_plug( this_rref_t ) ;
            virtual ~gl33_vignette_post_plug( void_t ) ;
        ...
        so_typedef( gl33_vignette_post_plug ) ;
    }
}