...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_CAMERA_3D_PERSPECTIVE_CAMERA_HPP_
#define _SNAKEOIL_MATH_CAMERA_3D_PERSPECTIVE_CAMERA_HPP_
...
namespace so_math
{
    namespace so_3d
    {
        ...
        class perspective_camera
        {
            ...
            typedef so_math::so_3d::ray< type_t > ray3_t ;
            ...
            typedef so_math::quaternion4< type_t > quat4_t ;
            typedef quat4_t const & quat4_cref_t ;

            typedef so_math::so_3d::frustum< type_t > frustum_t ;
        ...
        public:
            ...
            {
                so_math::so_3d::set_pos_for_camera_matrix( get_position() + delta, _cam ) ;
            }
            ...
            {
                so_math::so_3d::create_view_matrix<type_t>( _cam, _view ) ;
            ...
            {
                so_math::so_3d::set_pos_for_camera_matrix<type_t>( pos, _cam ) ;
                so_math::so_3d::create_view_matrix<type_t>( _cam, _view ) ;
                reconstruct_frustum_planes() ;
                return *this ;
            }
            ...
            {
                so_math::so_3d::create_lookat<type_t>( pos, target, _cam ) ;
                so_math::so_3d::create_view_matrix<type_t>( _cam, _view ) ;
                reconstruct_frustum_planes() ;
                return *this ;
            }
            ...
            {
                so_math::so_3d::create_lookat_lh_from_vec<type_t>( get_position(), dir, up, right, _cam ) ;
                so_math::so_3d::create_view_matrix<type_t>( _cam, _view ) ;
                reconstruct_frustum_planes() ;
                return *this ;
            }
            ...
            this_ref_t build_projection_matrix( type_t width, type_t height, type_t fov, type_t nz, type_t fz )
            {
                ...
                so_math::so_3d::create_perspective_fov<type_t>( fov, aspect, nz, fz, _proj ) ;
                reconstruct_frustum_planes() ;
                return *this ;
            }
            ...
            {
                so_math::so_3d::create_perspective_fov<type_t>( _pp.x(), _pp.y(), _pp.z(), _pp.w(), _proj ) ;
                reconstruct_frustum_planes() ;
                return *this ;
            }
        ...
        public: // get vec
            ...
            {
                vec3_t pos ;
                so_math::so_3d::get_pos_from_camera_matrix( pos, _cam ) ;
                return pos ;
            }
            ...
            {
                vec3_t dir ;
                so_math::so_3d::get_dir_from_camera_matrix<type_t>( dir, _cam ) ;
                return dir ;
            }
            ...
            {
                vec3_t up ;
                so_math::so_3d::get_up_from_camera_matrix<type_t>( up, _cam ) ;
                return up ;
            }
            ...
            {
                vec3_t right ;
                so_math::so_3d::get_right_from_camera_matrix<type_t>( right, _cam ) ;
                return right ;
            }
        ...
        public: // ray
            ...
            {
                type_t w = so_math::so_3d::get_width_at<float_t>( get_fov(), get_aspect(), type_t( 1 ) ) ;
                type_t h = so_math::so_3d::get_height_at<float_t>( get_fov(), type_t( 1 ) ) ;
        ...
        so_typedefs( perspective_camera<float_t>, perspective_cameraf ) ;
    }
