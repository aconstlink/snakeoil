...
namespace so_thread
{
    ...
    private: // writer
        ...
        void_t writer_increment( void_t ) noexcept
        {
            ...
            _writer.wait( so_thread::semaphore_static::is_zero_funk,
                so_thread::semaphore_static::increment_funk ) ;

            // ensure that no reader is in critical section
            _reader.wait( so_thread::semaphore_static::is_zero_funk,
