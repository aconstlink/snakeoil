...
namespace so_gfx
{
    ...
    public:
        ...
        void_t schedule_for_init( size_t const wid = 0 ) ;
        void_t schedule_for_clear( size_t const wid = 0 ) ;
        void_t schedule_for_begin( size_t const wid = 0 ) ;
        void_t schedule_for_end( size_t const wid = 0 ) ;
        void_t schedule_for_reload( size_t const wid = 0 ) ;
        void_t schedule_for_release( size_t const wid = 0 ) ;
