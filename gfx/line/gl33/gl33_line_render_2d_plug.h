...
namespace so_gfx
{
    namespace so_gl33
    {
        class SNAKEOIL_GFX_API gl33_line_render_2d_plug : public so_gpx::plug<so_gpu::so_gl::igl_33_api >
        {
            typedef so_gpx::plug<so_gpu::so_gl::igl_33_api > this_base_t ;
            so_this_typedefs( gl33_line_render_2d_plug ) ;

        private:

            so_gfx::line_render_2d_shared_data_ptr_t _sd = nullptr ;
        ...
        private: // rendering stuff
            ...
            data_buffer_ptr_t _line_info_ptr = nullptr ;

            /// the number of lines in the vertex buffer
            size_t _num_lines = 10000 ;
        ...
        public:
            ...
            gl33_line_render_2d_plug( so_gfx::line_render_2d_shared_data_ptr_t,
                so_gpu::so_gl::igl_33_api_ptr_t ) ;
            gl33_line_render_2d_plug( this_cref_t ) = delete ;
            gl33_line_render_2d_plug( this_rref_t ) ;
            virtual ~gl33_line_render_2d_plug( void_t ) ;
        ...
        so_typedef( gl33_line_render_2d_plug ) ;
    }
}