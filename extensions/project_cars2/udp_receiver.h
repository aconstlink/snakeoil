...
{
    class SNAKEOIL_PROJECT_CARS2_API udp_receiver
    {
        so_this_typedefs( udp_receiver ) ;

    private:

        so_project_cars2::shared_data_ptr_t _shared = nullptr ;
    ...
    public:
        ...
        bool_t start( so_project_cars2::shared_data_ptr_t, so_thread::sync_object_ptr_t ) ;

    private:

        static void_t transform_car_state_V2( uint8_ptr_t, so_project_cars2::car_states_out_t ) ;
        static void_t transform_weather_stateV2( uint8_ptr_t, so_project_cars2::weather_states_out_t ) ;
        static void_t transform_car_state_V2P5( uint8_ptr_t, so_project_cars2::car_states_out_t ) ;
        static void_t transform_weather_state_V2P5( uint8_ptr_t, so_project_cars2::weather_states_out_t ) ;
    ...
    private:
        ...
        static void_t print_out( so_project_cars2::car_states const & ) ;
