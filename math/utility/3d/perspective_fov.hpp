...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_UTILITY_U3D_PERSPECTIVE_FOV_HPP_
#define _SNAKEOIL_MATH_UTILITY_U3D_PERSPECTIVE_FOV_HPP_
...
namespace so_math
{
    namespace so_3d
    {
        namespace so_internal
        {
            ...
            {
                so_this_typedefs( perspective_projection<T> ) ;
                so_typedefs( T, type ) ;
        ...
        struct perspective
        {
            so_this_typedefs( perspective<T> ) ;
            ...
            so_typedefs( so_internal::perspective_projection<type_t>, proj ) ;
