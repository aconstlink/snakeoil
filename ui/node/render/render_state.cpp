...
//*************************************************************************************
so_ui::result render_state::apply( so_ui::so_visitor::ivisitor_ptr_t ptr ) 
{
    auto res = ptr->visit( this ) ;

    base_t::traverse_decorated( ptr, res ) ;

    return ptr->post_visit( this ) ;
}

//*************************************************************************************
so_ui::result render_state::replace( node_ptr_t which, node_ptr_t with ) 
{
    return base_t::replace( which, with ) ;
}

//*************************************************************************************
so_ui::result render_state::detach( node_ptr_t which_ptr ) 
{
...
//*************************************************************************************
void_t render_state::set_decorated( so_ui::so_node::node_ptr_t nptr ) 
{
