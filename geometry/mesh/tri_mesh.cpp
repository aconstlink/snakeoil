...
{
    so_this_typedefs( per_vertex_index_vector ) ;
...
//*******************************************************************
tri_mesh::this_ptr_t tri_mesh::create( so_memory::purpose_cref_t purp )
{
    return so_geo::memory::alloc( this_t(), purp ) ;
}

//*******************************************************************
tri_mesh::this_ptr_t tri_mesh::create( this_cref_t rhv, so_memory::purpose_cref_t purp )
{
    return so_geo::memory::alloc( rhv, purp ) ;
}

//*******************************************************************
tri_mesh::this_ptr_t tri_mesh::create( this_rref_t rhv, so_memory::purpose_cref_t purp )
{
    return so_geo::memory::alloc( std::move(rhv), purp ) ;
}

//*******************************************************************
void_t tri_mesh::destroy( this_ptr_t ptr )
{
    so_geo::memory::dealloc( ptr ) ;
}

//*******************************************************************
so_geo::result tri_mesh::flatten( flat_tri_mesh_ref_t mesh_out ) const 
{    
    // do some checks
    {}

    size_t const num_position_components = 
        so_geo::vector_component_format_to_number( so_geo::vector_component_format::xyz ) ;
    ...
    //
    {
        ...
        mesh_out.position_format = so_geo::vector_component_format::xyz ;
        mesh_out.normal_format = so_geo::vector_component_format::xyz ;
        mesh_out.texcoord_format = so_geo::texcoord_component_format::uv ;

        size_t const uvb = texcoord_format == so_geo::texcoord_component_format::uvw ? 3 : 2 ;
...
//*******************************************************************
void_t tri_mesh::destroy( void_t ) 
{
    this_t::destroy( this ) ;
}
