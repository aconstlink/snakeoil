...
void_t udp_receiver::print_out( so_project_cars::car_states const & cs )
{
    ...
    so_log::log::status( "speed km/h : " + std::to_string( cs.speed_kmh() ) ) ;
    so_log::log::status( "speed mi/h : " + std::to_string( cs.speed_mph() ) ) ;
    so_log::log::status( "rpm : " + std::to_string( cs.rpm ) ) ;
    so_log::log::status( "max_rpm : " + std::to_string( cs.max_rpm ) ) ;

    so_log::log::status( "oil_temperature: " + std::to_string( cs.oil_temperature ) ) ;
    so_log::log::status( "oil_pressure : " + std::to_string( cs.oil_pressure ) ) ;
    so_log::log::status( "water_temperature : " + std::to_string( cs.water_temperature ) ) ;
    so_log::log::status( "water_pressure : " + std::to_string( cs.water_pressure ) ) ;

    so_log::log::status( "car_flags : " + std::to_string( cs.car_flags ) ) ;

    so_log::log::status( "fuel_capacity : " + std::to_string( cs.fuel_capacity ) ) ;
    so_log::log::status( "brake : " + std::to_string( cs.brake ) ) ;
    so_log::log::status( "throttle : " + std::to_string( cs.throttle ) ) ;
    so_log::log::status( "clutch : " + std::to_string( cs.clutch ) ) ;

    so_log::log::status( "steering : " + std::to_string( cs.steering ) ) ;
    so_log::log::status( "fuel_level : " + std::to_string( cs.fuel_level ) ) ;
    so_log::log::status( "gear : " + std::to_string( cs.gear ) ) ;
    so_log::log::status( "num_gears : " + std::to_string( cs.num_gears ) ) ;

    so_log::log::status( "count : " + std::to_string( ++count ) ) ;
