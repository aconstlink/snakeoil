...
//------------------------------------------------------------
#ifndef _SNAKEOIL_DEVICE_COMPONENTS_MULTI_LED_H_
#define _SNAKEOIL_DEVICE_COMPONENTS_MULTI_LED_H_
...
namespace so_device
{
    namespace so_component
    {
        ...
        struct multi_led : public output_component<multi_led>
        {
            size_t cid = size_t( -1 ) ;
