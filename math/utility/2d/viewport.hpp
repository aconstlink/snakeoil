...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_UTILITY_2D_VIEWPORT_HPP_
#define _SNAKEOIL_MATH_UTILITY_2D_VIEWPORT_HPP_
...
namespace so_math
{
	namespace so_2d
	{
		...
		public:
			...
			{ return so_math::vector2< type_t >( type_t(_width), type_t(_height) ) ; }

			template< typename type_t >
			so_math::vector2< type_t > get_xy( void_t ) const 
			{ return so_math::vector2< type_t >( type_t(_x), type_t(_y) ) ; }

			template< typename type_t >
			so_math::vector4< type_t > get_as_vec4( void_t ) const 
			{ return so_math::vector4< type_t >( type_t(_x), type_t(_y), type_t(_width), type_t(_height) ) ; }
		} ;
	}

	typedef so_2d::viewport viewport_2d_t ;
}
