...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_PRIMITIVE_2D_LINE_HPP_
#define _SNAKEOIL_MATH_PRIMITIVE_2D_LINE_HPP_
...
namespace so_math
{
	namespace so_2d
	{
		...
		public:
			...
			{
				return so_math::fast<type_t>::abs( _plane.dot( vec3_t( point, type_t(1) ) ) ) ;
			}
