...
namespace so_gfx
{
    namespace so_gl33
    {
        class SNAKEOIL_GFX_API gl33_framebuffer_end_plug :
            public so_gpx::plug<so_gpu::so_gl::igl_33_api >
        {
            typedef so_gpx::plug<so_gpu::so_gl::igl_33_api > this_base_t ;
            so_this_typedefs( gl33_framebuffer_end_plug ) ;


        public:

            gl33_framebuffer_end_plug( framebuffer_end_t::shared_data_ptr_t,
                so_gpu::so_gl::igl_33_api_ptr_t ) ;
            gl33_framebuffer_end_plug( this_cref_t ) = delete ;
            gl33_framebuffer_end_plug( this_rref_t ) ;
            virtual ~gl33_framebuffer_end_plug( void_t ) ;
        ...
        so_typedef( gl33_framebuffer_end_plug ) ;
    }
}