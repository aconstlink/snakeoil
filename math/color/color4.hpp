...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_COLOR_COLOR4_HPP_
#define _SNAKEOIL_MATH_COLOR_COLOR4_HPP_
...
namespace so_math
{
    ...
    public:
        ...
        color4( so_switch::color_red ) : _color(vec4_t(type_t(1),type_t(0),type_t(0),type_t(1))) {}
        color4( so_switch::color_green ) : _color(vec4_t(type_t(0),type_t(1),type_t(0),type_t(1))) {}
        color4( so_switch::color_blue ) : _color(vec4_t(type_t(0),type_t(0),type_t(1),type_t(1))) {}
