...
namespace so_gfx
{
    class SNAKEOIL_GFX_API circle_render_2d
    {
        so_this_typedefs( circle_render_2d ) ;
    ...
    private:
        ...
        so_gfx::circle_render_2d_plug_factory_ptr_t _fac_ptr = nullptr ;

        so_gfx::circle_render_2d_shared_data_ptr_t _sd_ptr = nullptr ;
    ...
    public:
        ...
        circle_render_2d( so_gpx::render_system_ptr_t ) ;
        circle_render_2d( this_cref_t ) = delete ;
        circle_render_2d( this_rref_t ) ;
        ~circle_render_2d( void_t ) ;
    ...
    public:
        ...
        so_gfx::result draw_circle( size_t const group, so_math::vec2f_cref_t pos, so_math::vec2f_cref_t pivot, 
