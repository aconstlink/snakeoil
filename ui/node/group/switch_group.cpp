...
//*******************************************************************
so_ui::result switch_group::switch_child( size_t child_i, bool_t active ) 
{
...
//*******************************************************************
so_ui::result switch_group::switch_off_all( void_t )  
{
...
//*******************************************************************
so_ui::result switch_group::switch_on( node_ptr_t nptr ) 
{
    if( nptr == nullptr ) 
        return so_ui::invalid_argument ;
...
//*******************************************************************
so_ui::result switch_group::add_child( node_ptr_t nptr, bool_t active ) 
{
    if( nptr == nullptr ) 
        return so_ui::invalid_argument ;

    if( so_ui::no_success( base_t::add_child( nptr ) ) ) 
        return so_ui::failed ;
...
//*******************************************************************
so_ui::result switch_group::remove_child( node_ptr_t nptr ) 
{
    if( nptr == nullptr ) 
        return so_ui::invalid_argument ;
...
//*******************************************************************
so_ui::result switch_group::apply( so_ui::so_visitor::ivisitor_ptr_t vptr ) 
{
    vptr->visit( this ) ;
...
//*******************************************************************
so_ui::result switch_group::detach( node_ptr_t which_ptr ) 
{
