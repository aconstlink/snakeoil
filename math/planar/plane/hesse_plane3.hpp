...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_HESSE_PLANE3_HPP_
#define _SNAKEOIL_MATH_HESSE_PLANE3_HPP_
...
namespace so_math
{
    ...
    class hesse_plane< type_t, 3 >
    {
        ...
        typedef so_math::vector4< type_t > hesse_t ;
    ...
    public:
        ...
        inline vec3_t get_abs_normal( void_t ) const {
			...
			return vec3_t(
				so_math::fast<float_t>::abs(_plane.x()),
				so_math::fast<float_t>::abs(_plane.y()),
				so_math::fast<float_t>::abs(_plane.z())
				) ;
        }
