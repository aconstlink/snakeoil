...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_CPP_MATRIX_MATRIX4_HPP_
#define _SNAKEOIL_MATH_CPP_MATRIX_MATRIX4_HPP_
...
namespace so_math
{
    ...
    class matrix4
    {
        so_this_typedefs( matrix4<T> ) ;

        so_typedefs( T, type ) ;
        so_typedefs( so_math::vector3<T>, vec3 ) ;
        so_typedefs( so_math::vector4<T>, vec4 ) ;
        so_typedefs( so_math::matrix3<T>, mat3 ) ;
        so_typedefs( so_math::matrix4<T>, mat4 ) ;
    ...
    public: // ctor
        ...
        matrix4( so_math::so_matrix::with_identity )
        {
            for( size_t i = 0; i<16; ++i )
                _elem[i] = type_t(0) ;
        ...
        matrix4( so_math::so_matrix::xyzw )
            : matrix4( so_math::so_matrix::with_identity() )
        {}

        matrix4( so_math::so_matrix::xzyw )
        {
            for( size_t i = 0; i<16; ++i )
                _elem[i] = type_t(0) ;
    ...
    so_typedefs( matrix4<int_t>, mat4i ) ;
    so_typedefs( matrix4<float_t>, mat4f ) ;
    so_typedefs( matrix4<double_t>, mat4d ) ;
    so_typedefs( matrix4<uint_t>, mat4ui ) ;
    so_typedefs( matrix4<size_t>, mat4s ) ;
} 
