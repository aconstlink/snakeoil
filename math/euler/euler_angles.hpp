...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_EULER_EULER_ANGLES_HPP_
#define _SNAKEOIL_MATH_EULER_EULER_ANGLES_HPP_
...
namespace so_math
{
    ...
    class euler_angles
    {
        so_this_typedefs( euler_angles<T> ) ;
        so_typedefs( T, type ) ;

        so_typedefs( so_math::angle< T >, angle ) ;
        so_typedefs( so_math::vector3<angle_t>, angles ) ;
        so_typedefs( so_math::vector3<T>, vec3 ) ;
        so_typedefs( so_math::quaternion4<T>, quat4 ) ;

        so_typedefs( so_math::matrix3<T>, mat3 ) ;
        so_typedefs( so_math::so_3d::transformation<T>, trafo ) ;
    ...
    public:
        ...
        {
            vec3_t const x = vec3_t( so_math::so_vector::x_axis() ) ;
            vec3_t const y = vec3_t( so_math::so_vector::y_axis() ) ;
            vec3_t const z = vec3_t( so_math::so_vector::z_axis() ) ;

            switch( _sequence )
            {
                case so_math::euler_sequence::yxz:
                {
                    auto const mat_a = quat4_t( _angles.x().as_radians(), y,
                        so_math::so_quaternion::axis_normalized() ).to_matrix() ;
        ...
        {
            so_math::vec2f_t alpha, beta, gamma ;
            ...
            // beta
            {
                ...
                beta = so_math::vec2f_t( beta_1, beta_2 ) ;
            }
            ...
            // gamma
            {
                ...
                gamma = so_math::vec2f_t( gamma_1, gamma_2 ) ;
            }
            ...
            // alpha
            {
                ...
                alpha = so_math::vec2f_t( alpha_1, alpha_2 ) ;
            }
    ...
    so_typedefs( euler_angles<float_t>, euler_anglesf ) ;
    so_typedefs( euler_angles<double_t>, euler_anglesd ) ;
}
