...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_VECTOR4_HPP_
#define _SNAKEOIL_MATH_VECTOR4_HPP_
...
namespace so_math 
{
    ...
    class vector4
    {
        so_this_typedefs( vector4<T> ) ;

    public:

        so_typedefs( T, type ) ;
        so_typedefs( vector2< type_t >, vec2 ) ;
        so_typedefs( vector3< type_t >, vec3 ) ;
        so_typedefs( vector4< type_t >, vec4 ) ;
        so_typedefs( vector4b, vecb ) ;
        so_typedefs( vector4b, vec4b ) ;
    ...
    public: // common
        ...
        this_ref_t abs( void )
        {
            _elem[0] = so_math::fast<type_t>::abs(_elem[0]) ;
            _elem[1] = so_math::fast<type_t>::abs(_elem[1]) ;
            _elem[2] = so_math::fast<type_t>::abs(_elem[2]) ;
            _elem[3] = so_math::fast<type_t>::abs(_elem[3]) ;
            return *this ;
        }
    ...
    so_typedefs( vector4< char >, vec4c ) ;
    so_typedefs( vector4< unsigned char >, vec4uc ) ;
