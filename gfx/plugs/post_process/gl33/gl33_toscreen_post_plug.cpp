...
//------------------------------------------------------------
#include "gl33_toscreen_post_plug.h"
...
//*************************************************************************************
gl33_toscreen_post_plug::gl33_toscreen_post_plug( predef_post_t::shared_data_ptr_t sd_ptr,
    so_gpu::so_gl::igl_33_api_ptr_t aptr ) : this_base_t( sd_ptr, aptr )
{
    this_base_t::_vs_file_name = "gl33_toscreen_post.vs.glsl" ;
    this_base_t::_ps_file_name = "gl33_toscreen_post.ps.glsl" ;
}

//*************************************************************************************
gl33_toscreen_post_plug::gl33_toscreen_post_plug( this_rref_t rhv ) :
    this_base_t( std::move( rhv ) )
{}

//*************************************************************************************
gl33_toscreen_post_plug::~gl33_toscreen_post_plug( void_t )
{}

//*************************************************************************************
gl33_toscreen_post_plug::this_ptr_t gl33_toscreen_post_plug::create(
...
//*************************************************************************************
void_t gl33_toscreen_post_plug::destroy( this_ptr_t ptr )
{
    so_gfx::memory::dealloc( ptr ) ;
}

//*************************************************************************************
void_t gl33_toscreen_post_plug::destroy( void_t )
{
    this_t::destroy( this ) ;
}

//*************************************************************************************
void_t gl33_toscreen_post_plug::reconnect_variables( init_info_cref_t ii, so_gpu::variable_set_ptr_t vars ) 
{
    {
...

        {
            ...
            {
                so_log::global_t::error( "[gl33_toscreen_post_plug::reconnect_variables] : "
        ...
        }
        {
            ...
            auto const res = ii.mgr->get_tx2d_mgr()->acquire(
                name, "[gl33_toscreen_post_plug::on_initialize]", hnd ) ;
            if( so_core::is_not( res ) )
            {
                so_log::global::error( "[gl33_toscreen_post_plug::on_initialize] : "
...
//*************************************************************************************
void_t gl33_toscreen_post_plug::before_execute( void_t ) 
{
    _fb_dims = _var_fb_dims->get_data().zw() ;
...
//*************************************************************************************
void_t gl33_toscreen_post_plug::after_execute( void_t ) 
{
}