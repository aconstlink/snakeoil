...
mld_effect_generator::mld_effect_generator( mld_generate_params_cref_t, 
    so_shade::so_generator::so_glsl_es::generator_properties_cref_t gp ) : effect_generator(gp)
{
    ...
    so_shade::so_shader::effect_out_t eout ) 
{
    ...
    return this_t::generate_glsl_es1_mld_effect_from( mat_ptr, eout ) ;
}

//*************************************************************************************
so_shade::result mld_effect_generator::generate_glsl_es1_mld_effect_from(
    so_shade::so_material::standard_material_ptr_t mat_ptr,
    so_shade::so_shader::effect_out_t eout ) 
{
...

    {
        eff.set_vertex_shader( so_shade::so_shader::vertex_shader_t::create(
            ...
            "[so_shade::mld_effect_generator::generate_glsl_es1_effect_from] : vertex shader" ) ) ;

        so_std::string_t code ;
        code += "// [GEN] : snakeoil gles glsl 1.0 code generator : MLD\n" ;
        code += "#version 100\n" ;
        code += "\n" ;
        ...
        code +=  this_t::generate_glsl_es1_mld_uniforms_from( mat_ptr, eff ) ;
        code += "\n" ;
        code += "// [GEN] : Defines \n" ;
        ...
        code += this_t::generate_glsl_es1_mld_varyings_from( mat_ptr ) ;
        //code += "}vso ;\n" ;
        code += "\n" ;
        code += "void main()\n" ;
        code += "{\n" ;
        ...
        code += this_t::generate_glsl_es1_mld_linear_z_info_write_through_from( mat_ptr ) ;
        code += "\n" ;
...

    {
        eff.set_pixel_shader( so_shade::so_shader::pixel_shader_t::create(
            ...
            "[so_shade::mld_effect_generator::generate_glsl_es1_effect_from] : pixel_shader" ) ) ;
        ...
        code += "\n" ;
        code += "// [GEN] : Uniforms \n" ;
        code += this_t::generate_glsl_es1_mld_uniforms_ps_from() ;
        ...
        code += this_t::generate_glsl_es1_mld_varying_defines_ps_from( mat_ptr ) ;
        code += "\n\n" ;
        ...
        code += this_t::generate_glsl_es1_pixel_shader_call_albedo_from() ;
        code += "\n" ;
        code += "// [GEN] : mld specifc\n" ;
        code += this_t::generate_glsl_es1_mld_z_comptue_ps_from() ;
        code += this_t::generate_glsl_es1_mld_mix_front_back_from() ;
        code += "\n" ;
        code += "// [GEN] : shader output \n" ;
        code += "gl_FragColor = final_color ; \n" ;        
        code += this_t::generate_glsl_es1_linear_z_output_ps_from() ;
        code += "}\n" ;
...
//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_uniforms_from(
    ...
    so_shade::so_shader::effect_ref_t ein )
{
    ...
    ein.get_vertex_shader()->add_custom_binding( 
        ...
        "[mld_effect_generator::generate_glsl_es1_mld_uniforms_from] : mld_variable_bindings" ) ) ;

    return std::move(expr) ;
}

//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_uniforms_ps_from( void_t ) 
{
    so_std::string_t expr ;
    expr += "uniform vec4 u_mld_info_0 ; \n" ;
    expr += "uniform vec4 u_mld_info_1 ; \n" ;
...
//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_varyings_from(
    so_shade::so_material::standard_material_ptr_t mat_ptr ) 
{
    so_std::string_t expr ;
...
//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_varying_defines_ps_from(
    so_shade::so_material::standard_material_ptr_t ) 
{
    so_std::string_t expr ;

    expr += "#define __mld_near var_linear_z_info.x \n" ;
    expr += "#define __mld_far var_linear_z_info.y \n" ;
    expr += "#define __linear_z var_linear_z_info.z \n" ;

    return std::move( expr ) ;
}

//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_linear_z_info_write_through_from(
    so_shade::so_material::standard_material_ptr_t mat_ptr ) 
{
    so_std::string_t expr ;
    ...
    expr += "var_linear_z_info = ( vec3(mld_front_back,view_pos.z) - vec3(__near) ) /\
            \r(vec3( __far ) - vec3( __near )) ; \n" ;
    return std::move( expr ) ;
}

//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_z_comptue_ps_from( void_t ) 
{
    so_std::string_t expr ;
...
//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_mld_mix_front_back_from( void_t ) 
{
    so_std::string_t expr ;
...
//*************************************************************************************
so_std::string_t mld_effect_generator::generate_glsl_es1_linear_z_output_ps_from( void_t ) 
{
    so_std::string_t expr ;    
