...
//------------------------------------------------------------
#include "variable_node_component.h"
...
//*************************************************************************************
variable_node_component::variable_node_component( void_t )
{
...
//*************************************************************************************
variable_node_component::variable_node_component( this_rref_t rhv )
{
...
//*************************************************************************************
variable_node_component::this_ref_t variable_node_component::operator = ( this_rref_t rhv ) 
{
    so_move_member_ptr( _var_node_ptr, rhv ) ;
    so_move_member_ptr( _var_set_ptr, rhv ) ;
...
//*************************************************************************************
bool_t variable_node_component::reconnect_flow_node( void_t )
{
...
//*************************************************************************************
so_flow::variable_node_ptr_t variable_node_component::get_flow_node( void_t )
{
    return _var_node_ptr ;
}

//*************************************************************************************
bool_t variable_node_component::bind_variable( so_std::string_in_t bp, so_flow::ivariable_ptr_t ptr ) 
{
