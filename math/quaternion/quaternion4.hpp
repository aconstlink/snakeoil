...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_CPP_QUATERNION4_HPP_
#define _SNAKEOIL_MATH_CPP_QUATERNION4_HPP_
...
namespace so_math
{
    ...
    class quaternion4
    {
        so_this_typedefs( quaternion4<T> ) ;
        ...
        so_typedefs(so_math::quaternion3<T>, quat3 ) ;
    ...
    public: // ctors
        ...
        //************************************************************************************
        quaternion4( type_t angle, vec3_cref_t axis, so_math::so_quaternion::axis_normalized )
        {
    ...
    so_typedefs( quaternion4<float_t>, quat4f ) ;
    so_typedefs( quaternion4<double_t>, quat4d ) ;
