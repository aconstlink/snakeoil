...
so_math::vec3f_t const positions[8] =
{
    // front
    so_math::vec3f_t( -0.5f, -0.5f, 0.5f ),   // 0
    so_math::vec3f_t( -0.5f, 0.5f, 0.5f ),    // 1
    so_math::vec3f_t( 0.5f, 0.5f, 0.5f ),     // 2
    so_math::vec3f_t( 0.5f, -0.5f, 0.5f ),    // 3
    // back
    so_math::vec3f_t( -0.5f, -0.5f, -0.5f ),    // 4
    so_math::vec3f_t( -0.5f, 0.5f, -0.5f ),     // 5
    so_math::vec3f_t( 0.5f, 0.5f, -0.5f ),      // 6
    so_math::vec3f_t( 0.5f, -0.5f, -0.5f )      // 7
} ;
size_t const g_num_positions = 8 ;

/// one normal for each face
so_math::vec3f_t normals[6] =
{
    so_math::vec3f_t( 0.0f, 0.0f, 1.0f ),
    so_math::vec3f_t( 0.0f, 1.0f, 0.0f ),
    so_math::vec3f_t( 0.0f, 0.0f, -1.0f ),
    so_math::vec3f_t( 0.0f, -1.0f, 0.0f ),
    so_math::vec3f_t( -1.0f, 0.0f, 0.0f ),
    so_math::vec3f_t( 1.0f, 0.0f, 0.0f )
} ;
size_t const g_num_normals = 6 ;

so_math::vec2f_t tex_0[4] =
{
    so_math::vec2f_t( 0.0f, 0.0f ), // bottom left
    so_math::vec2f_t( 0.0f, 1.0f ), // top left
    so_math::vec2f_t( 1.0f, 1.0f ), // top right
    so_math::vec2f_t( 1.0f, 0.0f ) // bottom right
} ;
...
//*************************************************************************************
so_geo::result cube::make( polygon_mesh_ptr_t mesh_ptr, input_params_cref_t params_in ) 
{
    if( mesh_ptr == nullptr )
...
//*************************************************************************************
so_geo::result cube::make( tri_mesh_ptr_t mesh_ptr, input_params_cref_t params_in ) 
{
    if( mesh_ptr == nullptr )
        return so_geo::invalid_argument ;

    so_geo::tri_mesh_ref_t amesh = *mesh_ptr ;
...
//*************************************************************************************
so_geo::result cube::make( flat_line_mesh_ptr_t mesh_ptr, input_params_cref_t params_in )
{
    if( mesh_ptr == nullptr )
        return so_geo::invalid_argument ;

    so_geo::flat_line_mesh_ref_t amesh = *mesh_ptr ;
