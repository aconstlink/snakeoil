...
//*******************************************************************
void_t row_layout::user_data::destroy( void_t )
{
    so_ui::memory::dealloc( this ) ;
}

//*******************************************************************
row_layout::this_ptr_t row_layout::create( so_memory::purpose_cref_t purp )
{
    return so_ui::memory::alloc( this_t(), purp ) ;
}

//*******************************************************************
row_layout::this_ptr_t row_layout::create( this_rref_t rhv, so_memory::purpose_cref_t purp )
{
...
//*******************************************************************
row_layout::row_layout( iparent_ptr_t ptr ) : base_t( ptr )
{}

//*******************************************************************
row_layout::row_layout( this_rref_t rhv ) : base_t( std::move( rhv ) )
{}
...
//*******************************************************************
so_ui::result row_layout::add_child( node_ptr_t nptr, float_t const weight )
{
    auto * uptr = so_ui::memory::alloc( this_t::user_data_t(), 
        "[row_layout::add_child] : user_data" ) ;
...
//*******************************************************************
float_t row_layout::get_max_weight( void_t ) const
{
...
//*******************************************************************
float_t row_layout::get_weight( size_t const child_i ) const
{
...
//*******************************************************************
size_t row_layout::remove_child( node_ptr_t nptr )
{
    return base_t::remove_child( nptr ) ;
}

//*******************************************************************
so_ui::result row_layout::apply( so_ui::so_visitor::ivisitor_ptr_t vptr )
{
