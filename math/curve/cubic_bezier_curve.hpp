...
//------------------------------------------------------------
#ifndef _SNAKEOIL_MATH_CURVE_CUBIC_BEZIER_CURVE_HPP
#define _SNAKEOIL_MATH_CURVE_CUBIC_BEZIER_CURVE_HPP
...
namespace so_math
{
    /**
        ...
        four control points together and interpolate using a 
        parameter t.
    */
    template< typename T >
    ...
    {
        so_typedefs( T, value ) ;
        so_typedefs( T, cpoint ) ;
        so_this_typedefs( cubic_bezier_curve<cpoint_t> ) ;
    ...
    public:
        ...
        {
            return so_math::interpolation<cpoint_t>::cubic( 
