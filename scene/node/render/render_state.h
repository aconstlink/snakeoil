...
//------------------------------------------------------------
#ifndef _SNAKEOIL_SCENE_NODE_RENDER_RENDER_STATE_H_
#define _SNAKEOIL_SCENE_NODE_RENDER_RENDER_STATE_H_
...
namespace so_scene
{
    namespace so_node
    {
        ...
        class SNAKEOIL_SCENE_API render_state : public decorator
        {
