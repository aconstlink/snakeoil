...
namespace so_ui
{
    ...
    {
        class SNAKEOIL_UI_API rect_render_2d : public visitor
        {
        ...
        private: // other variables
            ...
            so_gfx::rect_render_2d_ptr_t _rnd_ptr = nullptr ;

        public:

            rect_render_2d( void_t ) ;
            rect_render_2d( so_gfx::rect_render_2d_ptr_t ) ;
            rect_render_2d( this_cref_t ) = delete ;
            rect_render_2d( this_rref_t ) ;
            virtual ~rect_render_2d( void_t ) ;
        ...
        public:
            ...
            void_t set_render( so_gfx::rect_render_2d_ptr_t ) ;
            so_gfx::rect_render_2d_ptr_t get_render( void_t ) ;
