...
namespace so_device
{
    ...
    {
        class nes_0810_e501_controller : public ines_controller
        {
            so_this_typedefs( nes_0810_e501_controller ) ;
        ...
        public:
            ...
            nes_0810_e501_controller( void_t ) {}
            nes_0810_e501_controller( this_cref_t rhv ) : _values( rhv._values ) {}
            ...
            virtual void_t update( std::array< byte_t, 8 > const & v )
            {
                ...
                // 47 : 0010 1111 : a
                {
                    auto const btn = v[ 5 ] >> 4 ;

                    if( btn == 1 ) values |= 1 << 1 ;
                    else if( btn == 2 ) values |= 1 << 0 ;
        ...
        so_typedef( nes_0810_e501_controller ) ;
    }
}