...
#include "gl33/gl33_sdf_a_plug.h"
#endif
...
//***********************************************************
sdf_a_plug_factory::sdf_a_plug_factory( sox_presentation::transitions::sdf_a_shared_data_ptr_t ptr ) 
{
    _sd = ptr ;
}

//***********************************************************
sdf_a_plug_factory::sdf_a_plug_factory( this_rref_t rhv ) : iplug_factory( std::move( rhv ) )
{
    so_move_member_ptr( _sd, rhv ) ;
}

//***********************************************************
sdf_a_plug_factory::~sdf_a_plug_factory( void_t )
{
}

//***********************************************************
sdf_a_plug_factory::this_ptr_t sdf_a_plug_factory::create( 
...
//***********************************************************
void_t sdf_a_plug_factory::destroy( this_ptr_t ptr )
{
    so_memory::global_t::dealloc( ptr ) ;
}

//***********************************************************
so_gpx::iplug_ptr_t sdf_a_plug_factory::create_plug( 
    so_gpu::api_type const t, so_gpu::iapi_ptr_t aptr )
{
    ...
    case so_gpu::api_type::gl_33:
        ...
        return transitions::gl_33::gl33_sdf_a_plug_t::create(
            transitions::gl_33::gl33_sdf_a_plug_t( _sd,
...
//***********************************************************
void_t sdf_a_plug_factory::destroy_plug( so_gpx::iplug_ptr_t ptr )
{
    ptr->destroy() ;
}

//***********************************************************
void_t sdf_a_plug_factory::destroy( void_t )
{
    this_t::destroy( this ) ;
}
